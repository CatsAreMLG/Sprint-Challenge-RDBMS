...
- Relational database management system is the basis for SQL

1. Why do tables need a `primary key`?

- tables need a primary key to differentiate rows from each other
...
- A new table with two foreign keys connecting the two tables
